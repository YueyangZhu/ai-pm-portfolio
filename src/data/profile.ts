...
export const profile: ProfileData = {
  ...
  intro:
    "7 年企业数字化产品经验，主导过协同办公、经营管理、风险管控、供应链与财务数据等多个 B 端复杂系统的从 0 到 1 建设与重构，覆盖大型国企、上市公司及独角兽企业。具备多端（Web、APP、PC、BI 大屏、小程序）产品设计与跨系统集成经验，能独立负责产品全生命周期管理。目前正在向企业 AI 产品经理方向转型，通过个人独立设计并使用 Vibe Coding 方式开发 AI 产品 Demo，实践从需求分析、工作流设计、Coze 编排、前端联调、测试到部署上线的完整过程。",
  highlights: [
